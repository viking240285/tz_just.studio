<header class="banner">
  <div class="md:mx-60 sticky top-0 z-50">
    <div class="container shadow-2xl  flex animate__animated items-center my-2 py-2 justify-between bg-black z-50 dark:bg-black sticky top-0 position-fixed"
        id="nav">
        <a href="{{ home_url('/') }}" class="text-dark dark:text-white columns-9 flex items-center mb-0">
            <img src="{{ asset('images/favicon.png') }}" class="mr-2 bg-black rounded" alt="">
            <p class="mb-0 text-white dark:text-white md:text-xl text-2xl">{!! $siteName !!}</p>
        </a>
